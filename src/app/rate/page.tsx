  ...
  const init = async () => {
    ...
    if (data.status === "awaiting_payment_method") {
      setContent({
        ...
        content:
          "Please rescan the QR Code to settle your payment method first.",
      });
    }
    if (data.status === "to_pay_cash") {
      setContent({
        title: "Thank you!",
        content:
          "Our Staff will confirm your payment in a moment. Please rate us for the meantime",
      });
    }
